...
public class SouthKoreanChartsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_south_korean_charts);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                listAssetsInSelection("South Korea/" + folders[i]);
                Intent intent = new Intent(getApplicationContext(), ImageGridActivity.class);
                intent.putExtra("com.nygard.itookacharttotheknee.path", "South Korea/" + folders[i]);
